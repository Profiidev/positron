...
export const groupSettings = z.object({
  ...
  oauth_client$edit: z.boolean().default(false),
  oauth_client$view: z.boolean().default(false),
  oauth_policy$edit: z.boolean().default(false),
  oauth_policy$view: z.boolean().default(false),
  oauth_scope$edit: z.boolean().default(false),
  oauth_scope$view: z.boolean().default(false),
